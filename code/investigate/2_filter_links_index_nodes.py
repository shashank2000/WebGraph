...
###############################################
# Note: this code kept running into issues (with dedup stage) for reason I could not figure out
#   Hence, divided this code into two files where 
...
# Note we changed the local directory here as we kept running into memory issues
# This slows down our run, though
...
output_hash_file_name = "filtered_links_with_hash_new.parquet"
output_file_name = "hash_links_new.tsv"
...
#output_hash_file_name = "2003_filtered_links_with_hash_num.parquet"
