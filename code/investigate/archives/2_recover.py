...
input_file_name = "filtered_links_with_hash_no_dedup_prev.parquet"
...
links = links.withColumn("Src", normalize_url(col("Src")))\
            .withColumn("Dest", normalize_url(col("Dest")))\
            .withColumn("Src_hash", xxhash_udf(col("Src")))\
            .withColumn("Dest_hash", xxhash_udf(col("Dest")))
